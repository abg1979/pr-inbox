...
| `{{REVIEWER_A_MODEL}}` | Default: `claude-opus-5`. The "exhaustive enumeration" reviewer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `{{REVIEWER_B_MODEL}}` | Default: `gpt-5.6-sol` (or the strongest available GPT family model). The "lateral pattern matching" reviewer.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
